package com.example.nguyenpro231998.navibarmenu.Adapter;
...
public class CustomAdapter extends BaseExpandableListAdapter {
    ...
    public CustomAdapter(Context context, List<String> listTitle, Map<String, List<String>> listItem) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView txtChild = (TextView) convertView.findViewById(R.id.list_Item);
